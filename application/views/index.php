...
<body class="home">
		...
		<header class="header">
			...
			<div class="logo">
				<a href="#">
					...
					<span class="logo-lnk">TUANWEB</span>
				</a>
			</div>
			...
			<a href="#" class="btn download-cv-btn">
				...
				<i class="icon fas fa-whatsapp-square"></i>
			</a>
		...
		<div class="wrapper">
			...
			<div class="background-bg">
				<div class="background-filter circle">
					<div class="background-img" style="background-image: url(<?php echo base_url() ?>assets/images/girl3.jpg);"></div>
				</div>
			</div>
					...
					<div class="content-carousel">
						<div class="owl-carousel" data-slidesview="4" data-slidesview_mobile="2">
							...
							<div class="item">
								<div class="clients-item">
									<a target="_blank" href="#">
										<img src="<?php echo base_url() ?>assets/images/client4.png" alt="" />
									</a>
								</div>
							</div>
				...
				<div class="content">
					...
					<div class="box-items">	
							...
							<div class="box-item">
								<div class="image">
									<a href="#gallery-1" class="has-popup-gallery">
										<img src="<?php echo base_url() ?>assets/images/works/work1.jpg" alt="" />
										<span class="info">
									...
									<div id="gallery-1" class="mfp-hide">
										<a href="<?php echo base_url() ?>assets/images/works/work1.jpg"></a>
										<a href="<?php echo base_url() ?>assets/images/works/work2.jpg"></a>
										<a href="<?php echo base_url() ?>assets/images/works/work3.jpg"></a>
										<a href="<?php echo base_url() ?>assets/images/works/work4.jpg"></a>
									</div>
								</div>
								<div class="desc">
							...
							<div class="box-item">
								<div class="image">
									<a href="https://youtu.be/S4L8T2kFFck" class="has-popup-video">
										<img src="<?php echo base_url() ?>assets/images/works/work2.jpg" alt="" />
										<span class="info">
											<span class="centrize full-width">
												<span class="vertical-center">
						...
						<div class="box-col f-image">
							<div class="box-item">
								<div class="image">
									<a href="<?php echo base_url() ?>assets/images/works/work7.jpg" class="has-popup-image">
										<img src="<?php echo base_url() ?>assets/images/works/work7.jpg" alt="" />
										<span class="info">
											<span class="centrize full-width">
												<span class="vertical-center">
								...
								<div class="desc">
									...
									<a href="<?php echo base_url() ?>assets/images/works/work7.jpg" class="name has-popup-image">White Rose Photo</a>
								</div>
							</div>
						</div>
						...
						<div class="box-col f-image">
							<div class="box-item">
								<div class="image">
									<a href="<?php echo base_url() ?>assets/images/works/work4.jpg" class="has-popup-image">
										<img src="<?php echo base_url() ?>assets/images/works/work4.jpg" alt="" />
										<span class="info">
											<span class="centrize full-width">
												<span class="vertical-center">
													<i class="icon fas fa-image"></i>
								...
								<div class="desc">
									<div class="category">Image</div>
									<a href="<?php echo base_url() ?>assets/images/works/work4.jpg" class="name has-popup-image">Honest Company</a>
								</div>
							</div>
						</div>
							...
							<div class="box-item">
								<div class="image">
									<a href="#gallery-2" class="has-popup-gallery">
										<img src="<?php echo base_url() ?>assets/images/works/work5.jpg" alt="" />
										<span class="info">
											<span class="centrize full-width">
												<span class="vertical-center">
													<i class="icon fas fa-images"></i>
									...
									<div id="gallery-2" class="mfp-hide">
										<a href="<?php echo base_url() ?>assets/images/works/work5.jpg"></a>
										<a href="<?php echo base_url() ?>assets/images/works/work2.jpg"></a>
										<a href="<?php echo base_url() ?>assets/images/works/work3.jpg"></a>
										<a href="<?php echo base_url() ?>assets/images/works/work4.jpg"></a>
									</div>
							...
							<div class="box-item">
								<div class="image">
									<a href="https://w.soundcloud.com/player/?visual=true&amp;url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F221650664&amp;show_artwork=true" class="has-popup-music">
										<img src="<?php echo base_url() ?>assets/images/works/work6.jpg" alt="" />
										<span class="info">
											<span class="centrize full-width">
												<span class="vertical-center">
							...
							<div class="box-item">
								<div class="image">
									<a href="https://beshley.com/" class="has-popup-link" target="_blank">
										<img src="<?php echo base_url() ?>assets/images/works/work3.jpg" alt="" />
										<span class="info">
											<span class="centrize full-width">
												<span class="vertical-center">
							...
							<div class="box-item">
								<div class="image">
									<a href="#popup-1" class="has-popup-media">
										<img src="<?php echo base_url() ?>assets/images/works/work8.jpg" alt="" />
										<span class="info">
											<span class="centrize full-width">
												<span class="vertical-center">
	...
	<script src="<?php echo base_url() ?>assets/js/jarallax-video.js"></script>
	<script src="<?php echo base_url() ?>assets/js/jarallax-element.js"></script>
