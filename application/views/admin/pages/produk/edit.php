          ...
          <form enctype="multipart/form-data" role="form" method="post" action="">
            <div class="box-body">
              <div class="form-group">
                <label>Nama</label>
                <input type="text" class="form-control" required="" name="nama" value="<?php echo $edit->nama ?>">
              </div>
              <div class="form-group">
                <label>Sub Nama</label>
                <input type="text" class="form-control" name="sub" value="<?php echo $edit->sub_nama ?>">
                <p class="help-block">Sub nama/kepanjangan dari nama produk</p>
              </div>
              <div class="form-group">
                <label>Link Demo</label>
                <input type="text" class="form-control" required="" value="#" name="link" value="<?php echo $edit->link_demo ?>">
              </div>
              <div class="form-group">
